...
ActionController::Routing::Routes.draw do |map|
  ...
  map.event_settings 'users/event_settings', :controller => 'users', :action => 'event_settings', :conditions => { :method => :get }
  map.event_settings 'users/event_settings', :controller => 'users', :action => 'event_settings', :conditions => { :method => :put }
...
#      :copy_encounter => :post
  ...
  map.connect 'test_exception', :controller => 'application', :action => 'test_except_notification'
