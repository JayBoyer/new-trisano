...
server "trisano-prod-www.cchd.org", :app, :web, :db, :primary => true
...
set :database_host, 'trisano-prod-www.cchd.org'
...
set :mailer                      , "smtp"
## TODO Jay
set :mailer_host                 , 'trisano-prod-www.cchd.org'
...
##set :host                        , "trisano-dev-www.cchd.org/trisano"
set :cdc_state                   , '32'
